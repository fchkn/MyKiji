...
<div class="container-fluid">
    ...
    <div class="row mb-5 py-4">
        ...
        <div class="col-4 text-right">
            <input type="submit" class="btn btn-secondary btn-sm" name="edit_profileinfo" value="変更を保存"/>
        </div>
        ...
        <div class="col-10 m-0 align-self-center text-left form-group">
            <input type="file" class="form-control-file" id="profile_img" name="profile_img" value="ファイルを選択">
    ...
    <div class="row mb-5 py-4">
        <div class="col-8 text-left">
            <input type="text" class="form-control" name="email" placeholder="メールアドレス" value="<?php echo $auth_user->email ?>">
        </div>
        <div class="col-4 text-right">
            <input type="submit" class="btn btn-secondary btn-sm" name="edit_email" value="変更を保存"/>
        </div>
    </div>
    ...
    <div class="row mb-5 py-4">
        <div class="col-8 text-left">
            <input type="text" class="form-control" name="password_now" placeholder="現在のパスワード">
        </div>
        <div class="col-4 text-right">
            <input type="submit" class="btn btn-secondary btn-sm" name="edit_password" value="変更を保存"/>
        </div>
        <div class="col-8 mt-3 text-left">
            <input type="text" class="form-control" name="password_new" placeholder="新しいパスワード">
        </div>
        <div class="col-4"></div>
        <div class="col-8 mt-3 text-left">
            <input type="text" class="form-control" name="password_new_re" placeholder="新しいパスワード（再入力）">
        </div>
        <div class="col-4"></div>
    </div>
    ...
    <div class="row mb-5 py-4">
        <div class="col-8 text-left"><span class="text-danger">※退会するとアカウントは復元できません。<br>&emsp;投稿した記事は全て削除されます。</span></div>
