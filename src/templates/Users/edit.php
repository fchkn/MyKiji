...
<div class="container-fluid">
    ...
    <div class="row mb-5 py-4">
        ...
        <div class="col-2 text-left"><img src="/upload/profile_img/user_<?php echo $auth_user->id ?>.jpg?<?php echo $img_param ?>" alt="profile_img" class="img-thumbnail mr-1" style="min-width:60px; min-height:60px;">
    </div>
