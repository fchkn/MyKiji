...
<div class="container-fluid">
    ...
    <div class="row pb-5 justify-content-center">
        ...
        <div class="col-4 my-4 align-self-center text-right offset-2">
            <input type="button" class="btn btn-info btn-lg" onclick="location.href='/users/edit'" value="　戻る　"/>
        </div>
        <div class="col-4 my-4 align-self-center text-left"><input type="button" class="btn btn-info btn-lg" name="withdraw_btn" value="　退会　"/></div>
        <div class="col-2"></div>
    </div>
</div>
</form>
